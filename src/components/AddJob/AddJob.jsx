        ...
        >
          <DialogContent>
            <div style={{ "display": "flex" }}>
              <div style={{ "width": "20%" }}>
                <div style={{ "border": "1px solid orange", "borderRadius": "500px", "width": "100px", "color": "orange", "padding": "30px 10px 10px 10px","lineHeight": "15px", "fontWeight": "bold", "height": "100px", "display": "flex", "alignitems": "center", "textAlign": "center" }}>
                  Upload Logo
              </div>
              </div>
              <div style={{ "width": "70%" }}>
